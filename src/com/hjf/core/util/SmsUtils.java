...
public class SmsUtils {
    ...
    public static final String APPKEY ="a36f83c1112a07bd917371237aec1c35";//配置您申请的KEY
    public static final String SENDURL ="http://v.juhe.cn/sms/send";//请求接口地址
 
    /**
     * 【发送验证码短信】
     */
    public static boolean  sendValidateSms(String telePhone,String  code){
    	log.error("发送短信.... "+code);
        Map<String, Object> params = new HashMap<String, Object>();//请求参数
            params.put("mobile",telePhone);//接收短信的手机号码
            params.put("tpl_id","27129");//短信模板ID，请参考个人中心短信模板设置
        ...
        try {
            net(SENDURL, params, "GET");
        } catch (Exception e) {
        	e.printStackTrace();
            log.error("发送短息失败..."+e.getMessage());
            return  false;
        }
        return  true;
    }
    ...
    //2.发送短信
    public static boolean  sendSms(String telePhone,String  tpl_value,String tpl_id){
        Map<String, Object> params = new HashMap<String, Object>();//请求参数
            params.put("mobile",telePhone);//接收短信的手机号码
            ...
            params.put("dtype","json");//返回数据的格式,xml或json，默认json
        try {
            String  ret=net(SENDURL, params, "GET");
    ...
    public static void main(String[] args) {
   	 String msg="君行九州";
   	 sendValidateSms("15010123237", "1234");
